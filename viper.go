...
// SetIniLoadOptions sets the load options for ini parsing.
func SetIniLoadOptions(in ini.LoadOptions) { v.SetIniLoadOptions(in) }

func (v *Viper) SetIniLoadOptions(in ini.LoadOptions) {
	v.iniLoadOptions = in
}
